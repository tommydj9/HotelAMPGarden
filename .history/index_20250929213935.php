  ...
  <section id="camere" class="section colorful">
    <div class="wrap">
      ...
      <div class="rooms-grid">
        <?php 
          $camere = [
            ["nome"=>"Camera Singola","img"=>"images/standard.jpg","prezzo"=>"50€","descr"=>"1 letto matrimoniale 
BalconeVista mareAria condizionataBagno in cameraTV a schermo piatto"],
            ["nome"=>"Camera Matrimoniale","img"=>"images/superior.jpg","prezzo"=>"60€","descr"=>"Vista mare, balcone, letto king-size."],
