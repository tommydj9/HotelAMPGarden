      ...
      <div class="rooms-grid">
        <?php 
          $camere = [
            ...
            ["nome"=>"Camera Quadrupla","img"=>"images/suite.jpg","prezzo"=>"75€","descr"=>"2 letti singoli  e 1 letto matrimoniale 
            18 m²BalconeAria condizionataBagno in cameraTV a schermo piatto"]
          ];
          foreach($camere as $c){
