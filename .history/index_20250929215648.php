...
<body>
  ...
  <img src="images/logoAMPgarden.png" alt="Logo AMP Garden" style="height:40px;">
        ...
        foreach($camere as $c){
          ...
          <article class='room-card' style='flex:1 1 22%; display:flex; flex-direction:column; border-radius:10px; overflow:hidden; box-shadow:0 6px 20px rgba(0,0,0,0.1);'>
            ...
            <div class='room-body' style='padding:15px; display:flex; flex-direction:column; flex:1;'>
              ...
              <ul style='flex:1; margin-bottom:15px; color:#555; line-height:1.4; list-style:none; padding-left:0;'>
                ";
                foreach($c['descr'] as $d){
                  echo "<li style='display:flex; align-items:center; margin-bottom:5px;'>
