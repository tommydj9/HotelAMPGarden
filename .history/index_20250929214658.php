...
<body>
  ...
  <div class="wrap">
    ...
    <div class="rooms-grid" style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: space-between;">
      <?php 
        $camere = [
          [
            "nome"=>"Camera Singola",
            ...
            "prezzo"=>"50€",
            "descr"=>"Perfetta per chi viaggia da solo: 1 letto singolo, aria condizionata, bagno privato, Wi-Fi incluso."
          ],
          [
            ...
            "prezzo"=>"60€",
            "descr"=>"Ideale per coppie: 1 letto matrimoniale, balcone con vista mare, aria condizionata, TV a schermo piatto, bagno privato."
          ],
          [
            "nome"=>"Camera Tripla",
            "img"=>"https://cf.bstatic.com/xdata/images/hotel/max1024x768/676281074.jpg?k=292954e57ad148a0de944cada0ac5ba4fa5bf49641e46ba72f66823c0d4e9ab1&o=",
            "prezzo"=>"71€",
            "descr"=>"Spaziosa per famiglie: 1 letto matrimoniale + 1 singolo, 16 m², balcone vista mare, aria condizionata, TV, bagno privato."
          ],
          [
            ...
            "prezzo"=>"75€",
            "descr"=>"Perfetta per gruppi o famiglie: 2 letti singoli + 1 matrimoniale, 18 m², balcone, aria condizionata, bagno privato, TV a schermo piatto."
          ]
        ];

        foreach($camere as $c){
          echo "
          <article class='room-card' style='flex:1 1 22%; display:flex; flex-direction:column; border-radius:10px; overflow:hidden; box-shadow:0 6px 20px rgba(0,0,0,0.1);'>
            <img src='{$c['img']}' alt='{$c['nome']}' style='width:100%; height:180px; object-fit:cover;'>
            <div class='room-body' style='padding:15px; display:flex; flex-direction:column; flex:1;'>
              <h3 style='margin-bottom:5px; font-size:1.2rem; color:#ff6600;'>{$c['nome']}</h3>
              <p class='price' style='font-weight:700; font-size:1.1rem; margin-bottom:10px;'>Da <strong>{$c['prezzo']}/notte</strong></p>
              <p style='flex:1; margin-bottom:15px; color:#555; line-height:1.4;'>{$c['descr']}</p>
              <div class='room-actions' style='display:flex; gap:10px; flex-wrap:wrap;'>
                <a href='#prenota' class='btn btn-primary' style='flex:1;'>Prenota</a>
                <button class='btn btn-outline btn-open-preventivo' data-room='{$c['nome']}' style='flex:1;'>Richiedi preventivo</button>
              </div>
            </div>
          </article>
          ";
