...
<body>
  ...
  <section id="home" class="hero">
    <div class="hero-slider">
      <div class="slide active" style="background-image:url('images/spiaggia-colori.jpg');">
      ...
      <div class="slide" style="background-image:url('images/piscina.jpg');">
        <div class="hero-inner">
  ...
  <section id="camere" class="section colorful">
    <div class="wrap">
      ...
      <div class="rooms-grid">
        <?php 
          $camere = [
            ["nome"=>"Camera Standard","img"=>"images/standard.jpg","prezzo"=>"80€","descr"=>"Per 2 persone, bagno privato, aria condizionata, Wi-Fi."],
            ["nome"=>"Camera Superior","img"=>"images/superior.jpg","prezzo"=>"120€","descr"=>"Vista mare, balcone, letto king-size."],
            ["nome"=>"Suite","img"=>"images/suite.jpg","prezzo"=>"180€","descr"=>"Ampia, con soggiorno separato, ideale per famiglie."]
          ];
          foreach($camere as $c){
